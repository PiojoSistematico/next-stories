...
<div className=`${shimmer}`} bg-gray-100 flex flex-col gap-4 rounded-md overflow-hidden">
      <div className="bg-gray-200"></div>
      <div className="flex flex-col gap-2 p-2">
          <div className="p-4 bg-gray-300 shadow-sm shadow-gray-700 flex flex-row justify-between">
